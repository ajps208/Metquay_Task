          ...
          <div className="row gy-4 gx-3">
            <div className="col-lg-4 col-md-6">
              ...
              <p className="mt-4 small ">
                Your gateway to thrilling sports experiences – book events
                effortlessly with our ticket booking app!"
              </p>
            ...
            <div className="col-lg-2 col-md-6">
              ...
              <ul className="list-unstyled text-muted">
                ...
                <li>
                  <Link style={{ textDecoration: "none", color: "#8c8c8c" }}>
                    FAQ
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <p className="small ">
                Seize every moment! Book sports events effortlessly with our app
